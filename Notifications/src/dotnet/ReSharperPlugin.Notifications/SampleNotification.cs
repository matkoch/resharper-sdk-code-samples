    ...
    internal class SampleNotification
    {
        ...
        private void ShowNotification()
        {
            _userNotifications.CreateNotification(
                ...
                executed: new UserNotificationCommand("Executed", () => MessageBox.ShowInfo("Executed")),
                dismissed: new UserNotificationCommand("Dismissed", () => MessageBox.ShowInfo("Dismissed")));
        }
    }
}
