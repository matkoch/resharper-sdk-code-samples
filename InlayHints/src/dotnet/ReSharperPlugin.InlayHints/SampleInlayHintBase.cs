...
namespace ReSharperPlugin.CodeVision
{
    public abstract class SampleInlayHintBase : IInlayHintWithDescriptionHighlighting
    {
        ...
        public RichText Description => $"{nameof(SampleInlayHintBase)}.{nameof(Description)}";
        public string ToolTip => $"{nameof(SampleInlayHintBase)}.{nameof(ToolTip)}";
        public string ErrorStripeToolTip => $"{nameof(SampleInlayHintBase)}.{nameof(ErrorStripeToolTip)}";
    }
}
